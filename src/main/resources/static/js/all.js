		...
		if (data['status'] != 101 && data['data']['result'] != 0) {
			...
			if (thisPageName === "/user") {
				...
				if (data['data']['result']['leaveMessageNum'] !== 0) {
					$(".leaveWord").find("a").append($("<span class='leaveMessageNotReadNum am-margin-right am-fr am-badge am-badge-danger am-round'>" + data['dta']['result']['leaveMessageNum'] +"</span>"));
				}
			}
		}
	},
